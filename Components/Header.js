...
const Header = () => {
  ...
  const { user, handleUserAuth ,signoutButton }      = useContext(MediumContext)
    ...
    <div className={styles.wrapper}>
      <div className={styles.content}>
        ...
        <div className={styles.bannerNav}>
          <div><a href="https://shivnandanjha-portfolio.netlify.app">About Author</a></div>
          {/* <div>Membership</div> */}
          {/* USER */}
          {user ? (
            <>
              ...
              <div className={styles.accentedButton}>
                <div onClick={signoutButton}>Sign Out</div>
              </div>
            </>
          ) : (
            <>
