...
const styles = {
  ...
  title: `font-bold text-3xl font-serif`,
  subtitle: `font-mediumSerifItalic text-[1rem] text-[#292929]`,
  articleText: `font-mediumSerif text-[1.4rem] text-[#292929]`,
};

const ArticleMain = ({ post, author }) => {
  let url = "window.location.`/post/${post.id}`";
            ...
            <div className={styles.referencesContainer}>
              ...
              <div className={styles.socials}>
               ...
               <FacebookShareButton url={url}
                                    quote = {post[0].data?.title}
                ><FaFacebook /></FacebookShareButton> 
                <LinkedinShareButton title = {post[0].data?.title} summary = {post[0].data?.brief} url = {window.location.href} ><GrLinkedin /></LinkedinShareButton>
                <HiOutlineLink />
